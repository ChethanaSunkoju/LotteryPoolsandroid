package in.mindbrick.officelotterypools.MyLibrary;
...
public class PkDialogWithoutButton
{
    ...
    public PkDialogWithoutButton(Context context) {
    ...
    public void show() {
        ...
        if (isPositiveAvailable && isNegativeAvailable) {
            Rl_button.setBackgroundColor(mContext.getResources().getColor(R.color.white));
        } else {
